...
export interface ApiInvoiceInvoice extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    exportedAt: Schema.Attribute.DateTime;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::invoice.invoice'
    ...
    team: Schema.Attribute.Relation<'manyToOne', 'api::team.team'>;
    totalAmount: Schema.Attribute.Float & Schema.Attribute.DefaultTo<0>;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
  };
...
export interface ApiSectionSection extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    subtotal: Schema.Attribute.Float & Schema.Attribute.DefaultTo<0>;
...
export interface ApiTeamTeam extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    defaultClientBank: Schema.Attribute.Text;
    defaultClientIBAN: Schema.Attribute.String;
    defaultClientName: Schema.Attribute.String;
    defaultClientSwift: Schema.Attribute.String;
    defaultCurrency: Schema.Attribute.String &
      Schema.Attribute.DefaultTo<'USD'>;
    defaultNotes: Schema.Attribute.Text;
...
export interface PluginUsersPermissionsUser
  ...
  attributes: {
    ...
    > &
      Schema.Attribute.Private;
    memberOfTeams: Schema.Attribute.Relation<'manyToMany', 'api::team.team'>;
    ownedTeams: Schema.Attribute.Relation<'oneToMany', 'api::team.team'>;
    password: Schema.Attribute.Password &
      Schema.Attribute.Private &
      Schema.Attribute.SetMinMaxLength<{
        minLength: 6;
