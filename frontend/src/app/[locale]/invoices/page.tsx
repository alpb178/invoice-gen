    ...
    <div className="w-full px-4 md:px-10 lg:px-16 py-8">
      ...
      <div className="flex gap-2 mb-5 flex-wrap">
        ...
        >
          ...
          <option value="draft">{tp('draft')}</option>
          <option value="sent">{tp('sent')}</option>
          <option value="paid">{tp('paid')}</option>
                ...
                <div className="flex items-center gap-3 sm:gap-4 min-w-0">
                  ...
                  <div className="min-w-0">
                    <div className="flex items-center gap-3 flex-wrap">
                      <span className="font-semibold text-ink-900">{t('invoiceNumber', { number: a.number ?? '' })}</span>
                    ...
                    <div className="text-ink-500 text-sm mt-0.5 truncate">
                      {td('rowMeta', { client: a.clientName ?? '', date: a.date ?? '', author: a.author?.email || '—' })}
                    </div>
                  </div>
                </div>
