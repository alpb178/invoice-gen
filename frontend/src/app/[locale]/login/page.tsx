    ...
    <div className="min-h-screen flex items-center justify-center px-4">
      ...
      >
        <div className="text-center">
          ...
          <h1 className="font-serif-display text-2xl md:text-3xl font-medium tracking-tight text-ink-900">{t('title')}</h1>
        ...
        <div className="space-y-2">
          <label className="block text-xs text-ink-600">{ta('password')}</label>
