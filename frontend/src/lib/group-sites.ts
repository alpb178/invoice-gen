...
export const GROUP_SITES: GroupSite[] = [
  {
    ...
    localizedUrl: { es: 'https://www.corpsc.com/es', en: 'https://www.corpsc.com/en' },
    accent: '#1668e3',
  },
  {
    slug: 'tu-chamba',
    name: 'Tu Chamba',
    tagline: { es: 'Empleos en Bolivia', en: 'Jobs in Bolivia' },
  ...
  },
  {
    slug: 'iris-natural',
    name: 'Iris Natural',
    tagline: { es: 'Productos naturales', en: 'Natural products' },
  ...
  },
  {
    slug: 'dando-muela',
    name: 'Dando Muela',
    tagline: { es: 'Conoce gente y chatea', en: 'Meet people and chat' },
